...
upcino:
    ...
    ORG 005000H
data_dc_10: DB 238, 13
    ORG 005100H
data_dc_50: DB 125, 125
...
configuro:
    ...
    bsf LATF, 1, 1 ;LED en ((PORTF) and 0FFh), 1, a ON constante
    clrf TBLPTRU, 1
...
ab1: btfss PIR3, 7, 1 ;pregunto si ((PIR3) and 0FFh), 7, a=1
    bra ab1 ;aun no se levanta bandera ((PIR3) and 0FFh), 7, a
    bcf PIR3, 7, 1 ;ya se levanto y se vuelve a bajar ((PIR3) and 0FFh), 7, a
    movlb 4H
    TBLRD*
    movlb 3H
    movff TABLAT, TMR0H
...
ba1: btfss PIR3, 7, 1 ;pregunto si ((PIR3) and 0FFh), 7, a=1
    bra ba1 ;aun no se levanta bandera ((PIR3) and 0FFh), 7, a
    bcf PIR3, 7, 1 ;ya se levanto y se vuelve a bajar ((PIR3) and 0FFh), 7, a
    bra inicio
...
sipresione:
    ...
    movlb 4H
    bsf LATF, 0, 1 ;prendo LED
ab2: btfss PIR3, 7, 1 ;pregunto si ((PIR3) and 0FFh), 7, a=1
    bra ab2 ;aun no se levanta bandera ((PIR3) and 0FFh), 7, a
    bcf PIR3, 7, 1 ;ya se levanto y se vuelve a bajar ((PIR3) and 0FFh), 7, a
    movlb 4H
    TBLRD*
    movlb 3H
    ...
    movlb 4H
    bcf LATF, 0, 1 ;apago LED
ba2: btfss PIR3, 7, 1 ;pregunto si ((PIR3) and 0FFh), 7, a=1
    bra ba2 ;aun no se levanta bandera ((PIR3) and 0FFh), 7, a
    bcf PIR3, 7, 1 ;ya se levanto y se vuelve a bajar ((PIR3) and 0FFh), 7, a
    bra inicio
