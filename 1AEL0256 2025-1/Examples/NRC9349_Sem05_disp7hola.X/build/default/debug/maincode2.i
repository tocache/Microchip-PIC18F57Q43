...
configuro:
    ...
    movlw 80H
    movwf TRISD, 1
    movwf ANSELD, 1 ;((PORTD) and 0FFh), 6, a al ((PORTD) and 0FFh), 0, a como salidas digitales
    movlw 0F0H
    movwf TRISB, 1
    movwf ANSELB, 1 ;((PORTB) and 0FFh), 3, a al ((PORTB) and 0FFh), 0, a como salidas digitales
