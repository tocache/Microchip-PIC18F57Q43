...
upcino:
    ...
    ORG 000018H ;(IVTBASE + 2*08H), IVTBASE por defecto es 8H
    DW INT0_ISR shr 2

    PSECT ISRs, class=CODE, reloc=4
INT0_ISR:
    bcf PIR1, 0, 1 ;((PIR1) and 0FFh), 0, a=0
    btg LATF, 3, 1 ;basculamos LED en ((PORTF) and 0FFh), 3, a
...
configuro:
    ...
    bcf ANSELB, 4, 1
    bsf WPUB, 4, 1
    ;Por defecto el IVTBASE es 8H según hoja técnicas
    ;clrf IVTBASEU, 1
    ;clrf IVTBASEH, 1
    ;clrf IVTBASEL, 1 ;IVTBASE = 000000H
    bsf PIE1, 0, 1 ;((PIE1) and 0FFh), 0, a=1
    bcf PIR1, 0, 1
    bcf INTCON0, 0, 1 ;((INTCON0) and 0FFh), 0, a=0
    bsf INTCON0, 7, 1 ;((INTCON0) and 0FFh), 7, a=1
