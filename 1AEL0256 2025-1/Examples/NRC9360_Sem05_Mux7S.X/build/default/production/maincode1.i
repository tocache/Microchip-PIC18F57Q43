...
; movwf OSCEN, 1 ;LFINTOSC enabled, el CPU a 1KHz aprox
    ;configuracion del PPS para el TMR0 salga a ((PORTF) and 0FFh), 2, a
    movlb 2H ;al Bank2
    movlw 39H
    movwf RF2PPS, 1 ;TMR0 asignado a ((PORTF) and 0FFh), 2, a
    ...
    movlw 0FBH
    movwf TRISF, 1 ;((PORTF) and 0FFh), 2, a como salida
    movwf ANSELF, 1 ;((PORTF) and 0FFh), 2, a como digital
