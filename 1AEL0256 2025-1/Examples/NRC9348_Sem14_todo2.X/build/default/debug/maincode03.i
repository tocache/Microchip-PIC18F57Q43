...
void main(void) {
    ...
    while(1){
        ...
        if(distancia_hcsr04 <= 3){
            LATFbits.LATF3 = 1;
            _delay((unsigned long)((700)*(32000000UL/4000000.0)));
            LATFbits.LATF3 = 0;
            _delay((unsigned long)((19300)*(32000000UL/4000000.0)));
        }
        else if(distancia_hcsr04 >= 6){
            LATFbits.LATF3 = 1;
            _delay((unsigned long)((2300)*(32000000UL/4000000.0)));
            LATFbits.LATF3 = 0;
            _delay((unsigned long)((17700)*(32000000UL/4000000.0)));
        }
    }
}
