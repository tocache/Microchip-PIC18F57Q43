...
configuro:
    ...
    movlb 4H
    ;((PORTF) and 0FFh), 4, a como entrada digital con pullup activado
    bsf TRISF, 4, 1 ;((PORTF) and 0FFh), 4, a entrada
    bcf ANSELF, 4, 1 ;((PORTF) and 0FFh), 4, a digital
    bsf WPUF, 4, 1 ;((PORTF) and 0FFh), 4, a pullup enabled
    ;((PORTD) and 0FFh), 3, a como salida digital
    bcf TRISD, 3, 1 ;((PORTD) and 0FFh), 3, a salida
    bcf ANSELD, 3, 1 ;((PORTD) and 0FFh), 3, a digital
