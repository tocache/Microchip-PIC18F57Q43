...
configuro:
    ...
    bsf LATF, 1, 1 ;enciendo el LED en ((PORTF) and 0FFh), 1, a

inicio:
    btfss PIR3, 7, 1 ;pregunto si se levanto ((PIR3) and 0FFh), 7, a
    bra $-2 ;aun no se levanto la bandera salta para atras
    bcf PIR3, 7, 1 ;bajo la bandera
    btg LATF, 0, 1 ;basculo LED en ((PORTF) and 0FFh), 0, a
    bra inicio
