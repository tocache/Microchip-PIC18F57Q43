...
# 1 "./cabecera.inc" 1
;Los archivos de cabecera contienen configuraciones iniciales del CPU
...
configuro:
    ...
    ;((PORTE) and 0FFh), 1, a es la salida, ((PORTC) and 0FFh), 0, a es la entrada
    ...
    bcf ANSELC, 0, 1 ;((PORTC) and 0FFh), 0, a como dgital

;Codigo de la aplicación (del NOT)
inicio:
    btfss PORTC, 0, 1 ;Pregunto si ((PORTC) and 0FFh), 0, a es uno (si presione BTN)
