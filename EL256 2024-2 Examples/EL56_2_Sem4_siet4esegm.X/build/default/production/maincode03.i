...
configuro:
    ...
    bsf TRISE, 1, 1 ;((PORTE) and 0FFh), 1, a como entrada
    bcf ANSELE, 1, 1 ;((PORTE) and 0FFh), 1, a como digital
    ;conf adicional
    clrf TBLPTRU, 1
    movlw 10H
    movwf TBLPTRH, 1
...
inicio_conta:
    btfss PORTE, 1, 1 ;pregunto si presione boton ((PORTE) and 0FFh), 1, a
    bra otro
    movlb 5H
