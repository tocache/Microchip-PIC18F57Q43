...
configuro:
    ...
    bsf WPUB, 4, 1 ;((PORTB) and 0FFh), 4, a con pullup activada
...
inicio_mux:
    btfsc PORTB, 4, 1 ;Preguntar si presione el ((PORTB) and 0FFh), 4, a
...
siguiente2:
    movlb 4H
    btfss PORTB, 4, 1 ;pregunto si solte el boton ((PORTB) and 0FFh), 4, a
    bra $-2 ;aun mantengo pulsado ((PORTB) and 0FFh), 4, a
    bra inicio_mux
