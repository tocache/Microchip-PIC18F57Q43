...
configuro:
    ...
    bsf TRISF, 4, 1 ;((PORTF) and 0FFh), 4, a como entrada
    bcf ANSELF, 4, 1 ;((PORTF) and 0FFh), 4, a como digital
    bcf TRISB, 3, 1 ;((PORTB) and 0FFh), 3, a como salida
    bcf ANSELB, 3, 1 ;((PORTB) and 0FFh), 3, a como digital

inicio_NOT:
    btfss PORTF, 4, 1 ;Pregunto si ((PORTF) and 0FFh), 4, a=1
    bra falsazo ;Falso, salto a falsazo
    bcf LATB, 3, 1 ;Verdad, ((PORTB) and 0FFh), 3, a=0
    bra inicio_NOT ;Regreso a inicio_NOT
falsazo:
    bsf LATB, 3, 1 ;((PORTB) and 0FFh), 3, a=1
    bra inicio_NOT ;Regreso a inicio_NOT
