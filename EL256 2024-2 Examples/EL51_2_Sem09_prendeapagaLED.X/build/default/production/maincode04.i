...
unsigned char salida[]={0x81,0x42,0x24,0x18,0x24,0x42};
        ...
        for(var_x=0;var_x<6;var_x++){
            ...
            switch(estado){
                ...
                case 1:
                    ...
                    break;
                case 2:
                    _delay((unsigned long)((70)*(32000000UL/4000.0)));
                    break;
                case 3:
                    _delay((unsigned long)((30)*(32000000UL/4000.0)));
                    break;
            }
        }
    }
