...
inicio_compuerta_not:
    btfss PORTF, 0, 1 ;Pregunta si ((PORTF) and 0FFh), 0, a es uno
    bra falso ;Falso, salto a etiqueta falso
    bcf LATB, 0, 1 ;Verdad, apago LED en ((PORTB) and 0FFh), 0, a
    bra inicio_compuerta_not ;Salto a inicio
falso:
    bsf LATB, 0, 1 ;enciendo LED en ((PORTB) and 0FFh), 0, a
    bra inicio_compuerta_not ;Salto a inicio
