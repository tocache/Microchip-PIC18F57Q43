...
# 1 "C:/Users/klnla/.mchp_packs/Microchip/PIC18F-Q_DFP/1.25.433/xc8\\pic\\include\\pic18.inc" 1 3





# 1 "C:/Users/klnla/.mchp_packs/Microchip/PIC18F-Q_DFP/1.25.433/xc8\\pic\\include\\pic18_chip_select.inc" 1 3
# 334 "C:/Users/klnla/.mchp_packs/Microchip/PIC18F-Q_DFP/1.25.433/xc8\\pic\\include\\pic18_chip_select.inc" 3
# 1 "C:/Users/klnla/.mchp_packs/Microchip/PIC18F-Q_DFP/1.25.433/xc8\\pic\\include\\proc\\pic18f57q43.inc" 1 3
# 47 "C:/Users/klnla/.mchp_packs/Microchip/PIC18F-Q_DFP/1.25.433/xc8\\pic\\include\\proc\\pic18f57q43.inc" 3
CLKRCON equ 0039h
...
TOSU equ 04FFh
# 36960 "C:/Users/klnla/.mchp_packs/Microchip/PIC18F-Q_DFP/1.25.433/xc8\\pic\\include\\proc\\pic18f57q43.inc" 3
...
# 335 "C:/Users/klnla/.mchp_packs/Microchip/PIC18F-Q_DFP/1.25.433/xc8\\pic\\include\\pic18_chip_select.inc" 2 3
# 7 "C:/Users/klnla/.mchp_packs/Microchip/PIC18F-Q_DFP/1.25.433/xc8\\pic\\include\\pic18.inc" 2 3
...
configuro:
    ...
    movlb 4H
    bsf TRISE, 0, 1 ;((PORTE) and 0FFh), 0, a como entrada
    bcf ANSELE, 0, 1 ;((PORTE) and 0FFh), 0, a como digital
    ;opcion 1 manipulacion individual de bits
    ;bcf TRISB, 0, 1 ;((PORTB) and 0FFh), 0, a como salida
    ;bcf TRISB, 1, 1 ;((PORTB) and 0FFh), 1, a como salida
    ;bcf ANSELB, 0, 1 ;((PORTB) and 0FFh), 0, a como digital
    ;bcf ANSELB, 1, 1 ;((PORTB) and 0FFh), 1, a como digital
    ;opcion 2 manipulacion numerica al registro
    movlw 0FCH
    movwf TRISB, 1 ;((PORTB) and 0FFh), 0, a y ((PORTB) and 0FFh), 1, a como salidas
    movwf ANSELB, 1 ;((PORTB) and 0FFh), 0, a y ((PORTB) and 0FFh), 1, a como digitales

inicio_train:
    btfss PORTE, 0, 1 ;Pregunto si ((PORTE) and 0FFh), 0, a es uno
    bra es_falso ;Falso, salta a label es_falso
    movlw 01H ;Verdad (efecto de luces del cruce de tren)
    movwf LATB, 1 ;((PORTB) and 0FFh), 1, a apagado, ((PORTB) and 0FFh), 0, a encendido
    call retardo ;llamo rutina de retardo
    movlw 02H
    movwf LATB, 1 ;((PORTB) and 0FFh), 1, a encendido, ((PORTB) and 0FFh), 0, a apagado
    call retardo ;llamo rutina de retardo
    bra inicio_train ;salta a label inicio_train
es_falso:
    clrf LATB, 1 ;todo el RB en cero (apagado ((PORTB) and 0FFh), 1, a y ((PORTB) and 0FFh), 0, a)
    bra inicio_train ;salta a label inicio_train
...
punto_1:
    ...
    movwf z_var, 1
punto_0:
    nop ;se va a repatir 500000 veces
    movlw 0
    cpfseq z_var, 1
    bra falso_z
    movlw 0
