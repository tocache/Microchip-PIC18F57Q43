...
configuro:
    ...
    bsf TRISF, 0, 1 ;((PORTF) and 0FFh), 0, a es entrada
    bcf ANSELF, 0, 1 ;((PORTF) and 0FFh), 0, a es digital
...
inicio_not:
    ...
    bcf LATB, 0, 1 ;Verdad, ((PORTB) and 0FFh), 0, a a cero lógico
    bra inicio_not ;Salta a label inicio_not
falsazo:
    bsf LATB, 0, 1 ;((PORTB) and 0FFh), 0, a a uno lógico
    bra inicio_not ;Salta a label inicio_not
