...
configuro:
    ...
    bsf TRISD, 0, 1 ;((PORTD) and 0FFh), 0, a como entrada
    bkf ANSELD, 0, 1 ;((PORTD) and 0FFh), 0, a como digital
    bcf TRISF, 0, 1 ;((PORTF) and 0FFh), 0, a como salida
    bcf ANSELF, 0, 1 ;((PORTF) and 0FFh), 0, a como digital

inicio_NOT:
    btfss PORTD, 0, 1 ;Pregunto si ((PORTD) and 0FFh), 0, a es uno
    bra falsazo ;Falso, salto a label falsazo
    bcf LATF, 0, 1 ;Verdad, ((PORTF) and 0FFh), 0, a a cero
    bra inicio_NOT ;Salto a inicio_NOT
falsazo:
    bsf LATF, 0, 1 ;((PORTF) and 0FFh), 0, a a uno
    bra inicio_NOT ;Salto a inicio_NOT
