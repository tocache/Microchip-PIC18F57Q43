...
configuro:
    ...
    bsf TRISF, 1, 1 ;((PORTF) and 0FFh), 1, a como entrada
    bcf ANSELF, 1, 1 ;((PORTF) and 0FFh), 1, a como digital
    bcf TRISE, 1, 1 ;((PORTE) and 0FFh), 1, a como salida
    bcf ANSELE, 1, 1 ;((PORTE) and 0FFh), 1, a como digital

inicio_NOT:
    btfss PORTF, 1, 1 ;Pregunto si ((PORTF) and 0FFh), 1, a=1
    bra falsazo ;FALSO, salto a label falsazo
    bcf LATE, 1, 1 ;VERDAD, ((PORTE) and 0FFh), 1, a = 0
    bra inicio_NOT ;salto a inicio_NOT
falsazo:
    bsf LATE, 1, 1 ;((PORTE) and 0FFh), 1, a = 1
    bra inicio_NOT ;salto a inicio_NOT
    end upcino
