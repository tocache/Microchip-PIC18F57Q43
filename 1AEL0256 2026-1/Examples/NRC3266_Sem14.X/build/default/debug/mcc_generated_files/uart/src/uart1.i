...
# 67 "mcc_generated_files/uart/src/../../system/../i2c_host/i2c1.h"
...
# 194 "mcc_generated_files/uart/src/../../system/../timer/tmr1.h"
...
# 264 "mcc_generated_files/uart/src/../../system/../timer/tmr1.h"
...
# 299 "mcc_generated_files/uart/src/../../system/../timer/tmr1.h"
...
void UART1_Write2(uint8_t txData);
void UART1_String_Write(const char *cadenasa);
void UART1_NewLine(void);
void UART1_8bitVar_Write(uint8_t numero);
void UART1_16bitVar_Write(uint16_t numero);
void UART1_Float_Write(float valor, int decimales);
...
# 39 "mcc_generated_files/uart/src/uart1.c" 2
...
void UART1_8bitVar_Write(uint8_t numero){
    UART1_Write2((numero / 100) + 0x30);
    UART1_Write2(((numero % 100) / 10) + 0x30);
    UART1_Write2((numero % 10) + 0x30);
}

void UART1_16bitVar_Write(uint16_t numero){
    UART1_Write2((numero / 10000) + 0x30);
    UART1_Write2(((numero % 10000) / 1000) + 0x30);
    UART1_Write2(((numero % 1000) / 100) + 0x30);
    UART1_Write2(((numero % 100) / 10) + 0x30);
    UART1_Write2((numero % 10) + 0x30);
}
