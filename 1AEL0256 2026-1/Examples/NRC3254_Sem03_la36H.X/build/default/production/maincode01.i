...
configuro:
    ...
    bsf TRISC, 5, 1 ;((PORTC) and 0FFh), 5, a como entrada
    bcf ANSELC, 5, 1 ;((PORTC) and 0FFh), 5, a como digital
    bsf WPUC, 5, 1 ;((PORTC) and 0FFh), 5, a con pullup activado

inicio:
    btfsc PORTC, 5, 1 ;pregunto si ((PORTC) and 0FFh), 5, a es cero
