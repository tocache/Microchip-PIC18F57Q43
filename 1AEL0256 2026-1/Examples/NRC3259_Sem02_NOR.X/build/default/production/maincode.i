...
configuro:
    ...
    bsf TRISC, 0, 1 ;((PORTC) and 0FFh), 0, a como entrada
...
inicio:
    btfsc PORTC, 0, 1 ;pregunto si ((PORTC) and 0FFh), 0, a es cero
    bra es_falso ;rpta falso, salta a label es_falso
    btfsc PORTE, 0, 1 ;rpta verdad, pregunto si ((PORTE) and 0FFh), 0, a es cero
    bra es_falso ;rpta falso, salta a label es_falso
    bsf LATF, 0, 1 ;rpta verdad, ((PORTF) and 0FFh), 0, a=1 o prendo el LED
    bra inicio ;salta a label inicio
es_falso:
    bcf LATF, 0, 1 ;((PORTF) and 0FFh), 0, a=0 o apagado el LED
