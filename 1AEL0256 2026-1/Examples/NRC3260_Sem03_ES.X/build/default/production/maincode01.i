...
upcino:
    ORG 000000H ;Vector de ((SMT1STAT) and 0FFh), 5, b
...
configuro:
    ...
    movwf ANSELF, 1 ;muevo wreg a ANSELF/((PORTF) and 0FFh), 4, a y ((PORTF) and 0FFh), 5, a como digitales
    movlw 30H ;cargo 30H a wreg
    movwf WPUF, 1 ;muevo wreg a WPUF/((PORTF) and 0FFh), 4, a y ((PORTF) and 0FFh), 5, a pullup enabled
inicio:
    btfsc PORTF, 4, 1 ;pregunto si ((PORTF) and 0FFh), 4, a es cero
    bra es_falso1 ;rpta falsa, salta a label es_falso1
    btfsc PORTF, 5, 1 ;rpta verdad, pregunta si ((PORTF) and 0FFh), 5, a es cero
    bra es_falso2 ;rpta falsa, salto a label es_falso2
    bra noventaynueve ;rpta verdad, salto a label noventaynueve}
es_falso1:
    btfsc PORTF, 5, 1 ;pregunto si ((PORTF) and 0FFh), 5, a es cero
