...
# 294 "./mcc_generated_files/system/../uart/uart1.h"
void UART1_16bitVar_Write(uint16_t numero);
# 304 "./mcc_generated_files/system/../uart/uart1.h"
void UART1_16bitVar_Write2(uint16_t numero, uint8_t c_digitos);
# 314 "./mcc_generated_files/system/../uart/uart1.h"
...
# 75 "main.c"
    while(1){
        ...
        UART1_16bitVar_Write2(DHT_GetTemp(0),2);
        UART1_String_Write(" °C");
        UART1_NewLine();
        UART1_String_Write("Humedad DHT11:");
        UART1_16bitVar_Write2(DHT_GetHumid(0),2);
