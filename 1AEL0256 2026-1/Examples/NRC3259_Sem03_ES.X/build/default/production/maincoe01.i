...
configuro:
    ...
    setf TRISF, 1 ;((PORTF) and 0FFh), 4, a y ((PORTF) and 0FFh), 5, a entradas
    movlw 0CFH
    movwf ANSELF, 1 ;((PORTF) and 0FFh), 4, a y R5 digitales
    movlw 30H
    movwf WPUF, 1 ;((PORTF) and 0FFh), 4, a y ((PORTF) and 0FFh), 5, a con pullup enabled
