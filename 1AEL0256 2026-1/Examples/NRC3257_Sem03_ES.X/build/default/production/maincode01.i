...
upcino:
    ORG 000000H ;Vector ((SMT1STAT) and 0FFh), 5, b
    bra configuro
...
configuro:
    ...
    bsf TRISE, 2, 1 ;((PORTE) and 0FFh), 2, a entrada
    bcf ANSELE, 2, 1 ;((PORTE) and 0FFh), 2, a digital
    bsf WPUE, 2, 1 ;((PORTE) and 0FFh), 2, a pullup enabled
    ;condiciones iniciales de operacion
    movlw 69H
    movwf LATD, 1 ;RD con valor 69H

inicio:
    btfsc PORTE, 2, 1 ;pregunto si ((PORTE) and 0FFh), 2, a=0
    bra $-2 ;rpta falso, salto a la linea anterior
    comf LATD, 1, 1 ;aplico complemento del puerto D
    btfss PORTE, 2, 1 ;pregunto si ((PORTE) and 0FFh), 2, a=1
    bra $-2 ;rpta falso, salto a la linea anterior
