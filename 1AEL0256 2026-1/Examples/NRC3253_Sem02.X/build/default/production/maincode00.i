...
configuro:
    ...
    movlw 0FCH
    movwf ANSELB, 1 ;((PORTB) and 0FFh), 1, a y ((PORTB) and 0FFh), 0, a como digital
...
inicio:
    ...
    btfss PORTB, 1, 1 ;Verdad y Preguntando si ((PORTB) and 0FFh), 1, a es uno
    bra falso ;Falso, salta a label falso
    bsf LATD, 0, 1 ;Verdad y enciende LED en ((PORTD) and 0FFh), 0, a
    bra inicio ;Salto a label inicio
falso:
    bcf LATD, 0, 1 ;apago LED en ((PORTD) and 0FFh), 0, a
    bra inicio ;Salto a label inicio
