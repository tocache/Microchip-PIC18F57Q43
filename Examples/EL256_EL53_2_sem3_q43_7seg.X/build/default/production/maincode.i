...
configuro:
    ...
    movlw 80H
    movwf TRISD
    movwf ANSELD ;((PORTD) and 0FFh), 6, a al ((PORTD) and 0FFh), 0, a como salidas digitales
    movlw 0FFH
    movwf TRISB
    clrf ANSELB ;((PORTB) and 0FFh), 3, a al ((PORTB) and 0FFh), 0, a como entradas digitales
    clrf TBLPTRU
    movlw HIGH deco7s
    movwf TBLPTRH
    movlw LOW deco7s
...
inicio:
    movlw 0FH
    andwf PORTB, W ;lectura de PORTB y enmascarmiento para que pase solo ((PORTB) and 0FFh), 0, a al ((PORTB) and 0FFh), 3, a
