...
void main(void) {
    ...
    MAX7219_WriteData2(0x0C, 0x00);
    MAX7219_WriteData2(0x0F, 0x00);
    MAX7219_WriteData2(0x0A, 0x03);
    MAX7219_WriteData2(0x0B, 0x07);
    MAX7219_WriteData2(0x0C, 0x01);
    MAX7219_WriteData2(0x09, 0x00);

    MAX7219_WriteData2(0x01, 0x00);
    MAX7219_WriteData2(0x02, 0x5B);
    MAX7219_WriteData2(0x03, 0x7E);
    MAX7219_WriteData2(0x04, 0x5B);
    MAX7219_WriteData2(0x05, 0x3E);
    MAX7219_WriteData2(0x06, 0x0E);
    MAX7219_WriteData2(0x07, 0x06);
    MAX7219_WriteData2(0x08, 0x00);
    _delay((unsigned long)((5000)*(32000000UL/4000.0)));
    POS_CURSOR(2,0);
    ESCRIBE_MENSAJE2("CONTADOR:       ");
    MAX7219_WriteData2(0x09, 0x0F);
    MAX7219_WriteData2(0x08, 0x4E);
    MAX7219_WriteData2(0x07, 0x1D);
    MAX7219_WriteData2(0x06, 0x15);
    MAX7219_WriteData2(0x05, 0x0F);
    while(1){
        unsigned int contador;
        for(contador=0;contador<8000;contador++){
            POS_CURSOR(2,9);
            LCD_ESCRIBE_VAR_INT(contador, 4, 0);
            MAX7219_WriteData2(0x04, (contador/1000));
            MAX7219_WriteData2(0x03, ((contador%1000)/100));
            MAX7219_WriteData2(0x02, ((contador%100)/10));
            MAX7219_WriteData2(0x01, (contador%10));
