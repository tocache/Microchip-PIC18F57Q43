...
configuro:
    ...
    movlw 80H
    movwf TRISB
    movwf ANSELB ;((PORTB) and 0FFh), 6, a al ((PORTB) and 0FFh), 0, a como salidas digitales
    movlw 0F0H
    movwf TRISA
    movwf ANSELA ;((PORTA) and 0FFh), 3, a al ((PORTA) and 0FFh), 0, a como salidas digitales
    clrf TBLPTRU
    movlw HIGH mensaje
    movwf TBLPTRH
    movlw LOW mensaje
