...
inicio:
    movlb 4H
    bsf LATD, 0, 1 ;((PORTD) and 0FFh), 0, a en uno (atendemos TON)
    movlb 3H
    movlw 0FCH
    movwf TMR0H, 1
    movlw 0E0H
    ...
    movlb 4H
otro:
    btfss PIR3, 7, 1 ;Pregunto si hubo match en TMR0, ((PIR3) and 0FFh), 7, a=1
    bra otro
    bcf PIR3, 7, 1 ;Bajamos la bandera TMR0 IF
    bcf LATD, 0, 1 ;((PORTD) and 0FFh), 0, a en cero (atendemos TOF)
    movlb 3H
    movlw 0FFH
    movwf TMR0H, 1
    movlw 38H
