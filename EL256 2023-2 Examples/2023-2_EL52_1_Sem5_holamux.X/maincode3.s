...
mensaje1:    DB	76H, 3FH, 38H, 77H 
    ORG 000220H		;Direccion de memoria de programa
		;C    E    R    O
mensaje2:    DB	39H, 79H, 50H, 3FH    
...
inicio:
    ...
    bra nopresione	;viene aqui cuando es falso
    clrf TBLPTRU, 1	;viene aqui cuando es verdadero
    movlw 02H
    movwf TBLPTRH, 1
    movlw 20H
    movwf TBLPTRL,1	;El TBLPTR esta mirando a dirección 220H de mem prog.
    bra siguiente
nopresione:
    clrf TBLPTRU, 1
    movlw 02H
