...
unsigned int efecto[]={0x0001,0x0002,0x0004,0x0008,0x0010,0x0020,0x0040,0x0080,0x0100,0x0200,0x0400,0x0800,0x1000,0x2000,0x4000,0x8000};
...
void splash_screen(void){
    ...
    I2C_POS_CURSOR(2,0);
    I2C_ESCRIBE_MENSAJE2("con el PCF8574");
...
void main(void) {
    configuro();
    I2C1_Write_MCP23017(0x20,0x00,0x00);
    I2C1_Write_MCP23017(0x20,0x01,0x00);
    splash_screen();
    POS_CURSOR(1,0);
    ...
    I2C_POS_CURSOR(2,0);
    I2C_ESCRIBE_MENSAJE2("BIN:");
    while(1){
        unsigned char x_var;
        for(x_var=0;x_var<15;x_var++){
            I2C1_Write_MCP23017(0x20, 0x14, efecto[x_var] & 0x00FF);
            I2C1_Write_MCP23017(0x20, 0x15, (efecto[x_var]>>8)&0x00FF);
            POS_CURSOR(1,4);
            LCD_ESCRIBE_VAR_CHAR(x_var, 3);
            POS_CURSOR(2,4);
            LCD_VARCHAR_BITS(x_var);
            POS_CURSOR(1,12);
            LCD_VARCHAR_HEX(x_var);
            I2C_POS_CURSOR(1,4);
            I2C_LCD_ESCRIBE_VAR_CHAR(efecto[x_var], 3);
            I2C_POS_CURSOR(2,4);
            I2C_LCD_VARCHAR_BITS(efecto[x_var]);
            I2C_POS_CURSOR(1,12);
            I2C_LCD_VARCHAR_HEX(efecto[x_var]);

        }
        for(x_var=15;x_var>0;x_var--){
            I2C1_Write_MCP23017(0x20, 0x14, efecto[x_var] & 0x00FF);
            I2C1_Write_MCP23017(0x20, 0x15, (efecto[x_var]>>8)&0x00FF);
            POS_CURSOR(1,4);
            LCD_ESCRIBE_VAR_CHAR(x_var, 3);
