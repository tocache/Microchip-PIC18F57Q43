...
configuro:
    ...
    bsf WPUB, 4, 1 ;((PORTB) and 0FFh), 4, a con pullup
...
inicio:
    ...
    bra nopresione ;Falso, ((PORTB) and 0FFh), 4, a es uno
    bsf LATF, 3, 1 ;Verdadero, enciendo el LED
    bra inicio ;Salto hacia etiqueta inicio
nopresione:
    bcf LATF, 3, 1 ;apago el LED
    bra inicio ;Salto hacia etiqueta inicio
