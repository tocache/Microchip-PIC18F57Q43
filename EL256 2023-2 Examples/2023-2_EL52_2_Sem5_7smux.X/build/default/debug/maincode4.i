...
configuro:
    ...
    movlw 0F0H
    movwf TRISB, 1 ;((PORTB) and 0FFh), 3, a al ((PORTB) and 0FFh), 0, a como salidas
    movwf ANSELB, 1 ;((PORTB) and 0FFh), 3, a al ((PORTB) and 0FFh), 0, a como digitales
    movlw 01H
    movwf LATB, 1 ;Esta habilitado el primer digito del display
