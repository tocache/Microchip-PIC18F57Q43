...
configuro:
    ...
    bsf TRISB, 4, 1 ;((PORTB) and 0FFh), 4, a como entrada
    bcf ANSELB, 4, 1 ;((PORTB) and 0FFh), 4, a como digital
    bsf WPUB, 4, 1 ;((PORTB) and 0FFh), 4, a pullup activado
    bcf TRISF, 3, 1 ;((PORTF) and 0FFh), 3, a como salida
    bcf ANSELF, 3, 1 ;((PORTF) and 0FFh), 3, a como digital
...
noescierto:
    bcf LATF, 3, 1 ;((PORTF) and 0FFh), 3, a a cero (LED se encienda)
    bra inicio ;retorna a inicio

siescierto:
    bsf LATF, 3, 1 ;((PORTF) and 0FFh), 3, a a uno (LED se apague)
    bra inicio ;retorna a inicio
