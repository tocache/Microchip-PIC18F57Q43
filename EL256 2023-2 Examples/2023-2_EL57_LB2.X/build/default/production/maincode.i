...
configuro:
    ...
    movlb 4H ;bank4
    bcf TRISE, 0, 1 ;((PORTE) and 0FFh), 0, a salida
    bcf ANSELE, 0, 1 ;((PORTE) and 0FFh), 0, a digital
    clrf TRISD, 1 ;RD salida
    clrf ANSELD, 1 ;RD digital
    setf TRISB, 1 ;((PORTB) and 0FFh), 1, a y ((PORTB) and 0FFh), 0, a entradas
    movlw 0FCH
    movwf ANSELB, 1 ;((PORTB) and 0FFh), 1, a y ((PORTB) and 0FFh), 0, a digitales
    clrf TBLPTRU, 1
    movlw 03H
    movwf TBLPTRH, 1
...
inicio: ;rutina principal
    movlb 4H
    movf PORTB, 0, 1 ;leo ((PORTB) and 0FFh), 1, a y ((PORTB) and 0FFh), 0, a
...
estado_0: ;duty cycle 10%
    movlb 4H
    bsf LATE, 0, 1 ;((PORTE) and 0FFh), 0, a a uno
    movlb 3H
    movlw 0FFH
    movwf TMR0H, 1
    movlw 0F1H
    ...
    bcf LATE, 0, 1 ;((PORTE) and 0FFh), 0, a a cero
    movlb 3H
    movlw 0FFH
    movwf TMR0H, 1
    movlw 47H
