...
configuro:
    ...
    movlb 4H ;bank4
    bcf TRISB, 0, 1 ;((PORTB) and 0FFh), 0, a salida
    bcf ANSELB, 0, 1 ;((PORTB) and 0FFh), 0, a digital
    clrf TRISD, 1 ;RD salida
    clrf ANSELD, 1 ;RD digital
    setf TRISC, 1 ;((PORTC) and 0FFh), 1, a y ((PORTC) and 0FFh), 0, a entradas
    movlw 0FCH
    movwf ANSELC, 1 ;((PORTC) and 0FFh), 1, a y ((PORTC) and 0FFh), 0, a digitales
    clrf TBLPTRU, 1
    movlw 03H
    movwf TBLPTRH, 1
...
inicio: ;rutina principal
    movlb 4H
    movf PORTC, 0, 1 ;leo ((PORTB) and 0FFh), 1, a y ((PORTB) and 0FFh), 0, a
...
estado_0: ;duty cycle 10%
    movlb 4H
    bsf LATB, 0, 1 ;((PORTB) and 0FFh), 0, a a uno
    movlb 3H
    movlw 0FFH
    movwf TMR0H, 1
    movlw 0DFH
    ...
    bcf LATB, 0, 1 ;((PORTB) and 0FFh), 0, a a cero
    movlb 3H
    movlw 0FEH
    movwf TMR0H, 1
    movlw 0D4H
