...
configuro:
    ...
    movlb 4H
    movlw 80H
    movwf TRISD, 1 ;((PORTD) and 0FFh), 6, a:((PORTD) and 0FFh), 0, a como salidas
    movwf ANSELD, 1 ;((PORTD) and 0FFh), 6, a:((PORTD) and 0FFh), 0, a como digitales
    movlw 0F0H ;11110000B
    movwf TRISB, 1 ;((PORTB) and 0FFh), 3, a:((PORTB) and 0FFh), 0, a como salidas
    movwf ANSELB, 1 ;((PORTB) and 0FFh), 3, a:((PORTB) and 0FFh), 0, a como digitales
