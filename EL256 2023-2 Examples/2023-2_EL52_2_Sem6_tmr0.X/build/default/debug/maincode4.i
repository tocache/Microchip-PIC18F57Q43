...
inicio:
    btfsc PORTB, 4, 1 ;Pregunto si presione el boton en ((PORTB) and 0FFh), 4, a
    bra nopresione
    bsf LATD, 0, 1 ;LED al 100%
    bra inicio

nopresione:
    bsf LATD, 0, 1 ;((PORTD) and 0FFh), 0, a=1
    movlb 3H
    movlw 0FFH
    movwf TMR0H, 1
    movlw 38H
    ...
    bcf PIR3, 7, 1 ;bajamos bandera ((PIR3) and 0FFh), 7, a
    bcf LATD, 0, 1 ;((PORTD) and 0FFh), 0, a=0
    movlb 3H
    movlw 0FCH
    movwf TMR0H, 1
    movlw 0E0H
