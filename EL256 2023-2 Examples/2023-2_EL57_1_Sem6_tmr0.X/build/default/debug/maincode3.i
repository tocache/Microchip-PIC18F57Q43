...
inicio:
    movlb 4H
    bsf LATD, 0, 1 ;((PORTD) and 0FFh), 0, a a uno
    movlb 3H
    movlw 0FFH
    movwf TMR0H, 1
    movlw 38H
...
otro:
    ...
    bra otro ;Aun no se levanta ((PIR3) and 0FFh), 7, a
    bcf PIR3, 7, 1 ;Bajamos bandera ((PIR3) and 0FFh), 7, a
    bsf LATD, 0, 1 ;((PORTD) and 0FFh), 0, a a cero
    movlb 3H
    movlw 0FFH
    movwf TMR0H, 1
    movlw 38H
...
otro2:
    btfss PIR3, 7, 1 ;Pregunto si ((PIR3) and 0FFh), 7, a=1
    bra otro2 ;Aun no se levanta ((PIR3) and 0FFh), 7, a
    bcf PIR3, 7, 1 ;Bajamos bandera ((PIR3) and 0FFh), 7, a
    bra inicio
