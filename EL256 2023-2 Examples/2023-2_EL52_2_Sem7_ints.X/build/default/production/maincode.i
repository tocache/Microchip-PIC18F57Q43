...
configuro:
    ...
    movlw 250
    movwf TMR0H, 1
    bcf IPR3, 7, 1 ;((IPR3) and 0FFh), 7, b=0 (low priority)
    movlb 4H ;bank4
    bsf PIE3, 7, 1 ;((PIE3) and 0FFh), 7, a=1
    bsf PIE1, 0, 1 ;((PIE1) and 0FFh), 0, a=1
    movlw 0E7H
    movwf INTCON0, 1 ;((INTCON0) and 0FFh), 7, a=1, ((INTCON0) and 0FFh), 6, a=1, IPEN=1
...
TMR0_ISR:
    btg LATC, 0, 1 ;complementamos ((PORTC) and 0FFh), 0, a
    bcf PIR3, 7, 1 ;bajamos ((PIR3) and 0FFh), 7, a
    retfie

INT0_ISR:
    btg LATD, 0, 1 ;complementamos ((PORTD) and 0FFh), 0, a
    bcf PIR1, 0, 1 ;bajamos ((PIR1) and 0FFh), 0, a
    retfie
