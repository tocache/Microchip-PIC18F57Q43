...
configuro:
    ...
    movlb 4 ;bank 4
    movlw 80H
    movwf TRISD ;((PORTD) and 0FFh), 6, a al ((PORTD) and 0FFh), 0, a son salidas
    movwf ANSELD ;((PORTD) and 0FFh), 6, a al ((PORTD) and 0FFh), 0, a son digitales
    movlw 0F0H
    movwf TRISB ;((PORTB) and 0FFh), 3, a al ((PORTB) and 0FFh), 0, a son salidas
    movwf ANSELB ;((PORTB) and 0FFh), 3, a al ((PORTB) and 0FFh), 0, a son digitales
    clrf TBLPTRU
    movlw HIGH mensaje
    movwf TBLPTRH
    movlw LOW mensaje
...
siguiente:
    bcf PIR3, 7 ;baja bandera ((PIR3) and 0FFh), 7, a
visualiz:
