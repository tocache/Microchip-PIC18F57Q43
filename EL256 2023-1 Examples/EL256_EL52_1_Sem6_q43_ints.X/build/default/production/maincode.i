...
configuro:
    ...
    bsf INTCON0, 6 ;((INTCON0) and 0FFh), 6, a=1
    bsf PIE1, 0 ;((PIE1) and 0FFh), 0, a=1
    bsf PIE6, 0 ;((PIE6) and 0FFh), 0, a=1
    bcf INTCON0, 0 ;INTEDG0=0
    bcf INTCON0, 1 ;INTEDG1=0
    bcf IPR6, 0 ;((IPR6) and 0FFh), 0, b=0
    ;conf adicionales
    movlw 01H
    movwf LATA
    clrf TBLPTRU
...
INT0_ISR:
    bcf PIR1, 0 ;((PIR1) and 0FFh), 0, a=0
    movlw 9
...
INT1_ISR:
    bcf PIR6, 0 ;((PIR6) and 0FFh), 0, a=0
    movlw 0
