...
configuro:
    ...
    bcf ANSELD, 0 ;((PORTD) and 0FFh), 0, a como digital
    bcf TRISF, 0 ;((PORTF) and 0FFh), 0, a como salida
    bcf ANSELF, 0 ;((PORTF) and 0FFh), 0, a como digital
    bsf TRISB, 4 ;((PORTB) and 0FFh), 4, a como entrada
    bcf ANSELB, 4 ;((PORTB) and 0FFh), 4, a como digital
    bsf WPUB, 4 ;pullup del ((PORTB) and 0FFh), 4, a habilitado
    bcf LATD, 0 ;((PORTD) and 0FFh), 0, a apagado
    bcf LATF, 0 ;((PORTF) and 0FFh), 0, a apagado
    movlb 0H ;BSR al bank 0
inicio:
    btfsc PORTB, 4 ;pregunto si presione boton
    goto inicio ;aun no he pulsado
    bsf LATF, 0 ;enciendo ((PORTF) and 0FFh), 0, a
aunno1:
...
aunno2:
    ...
    bsf LATD, 0 ;enciendo ((PORTD) and 0FFh), 0, a
aunno3:
    btfss PORTB, 4 ;pregunto si solte el boton
    goto aunno3
aunno4:
    ...
    bcf LATF, 0 ;apago ((PORTF) and 0FFh), 0, a
    bcf LATD, 0 ;apago ((PORTD) and 0FFh), 0, a
aunno5:
    btfss PORTB, 4 ;pregunto si solte el boton
    goto aunno5
    goto inicio
