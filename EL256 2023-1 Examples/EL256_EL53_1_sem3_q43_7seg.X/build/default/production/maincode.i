...
configuro:
    ...
    movwf TRISD ;((PORTD) and 0FFh), 6, a al ((PORTD) and 0FFh), 0, a como salidas, en TRISx 0 es salida, 1 es entrada
    movwf ANSELD ;((PORTD) and 0FFh), 6, a al ((PORTD) and 0FFh), 0, a como digitales
    movlw 0FFH ;1111 1111 en binario
    movwf TRISB ;forzamos ((PORTB) and 0FFh), 3, a al ((PORTB) and 0FFh), 0, a como entradas
    movlw 0F0H
    movwf ANSELB ;((PORTB) and 0FFh), 3, a al ((PORTB) and 0FFh), 0, a como digitales
