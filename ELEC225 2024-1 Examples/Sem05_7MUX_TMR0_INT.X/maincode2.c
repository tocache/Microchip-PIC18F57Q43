...
//unsigned char mensaje[] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x73, 0x38, 0x3E, 0x15, 0x3F, 0x54, 0x00, 0x00, 0x00, 0x00, 0x00};
unsigned char mensaje[] = {"      PLUMON     "};
...
void main(void) {
    configuro();
    while(1){
        LATD = decod[mensaje[indice]-0x41];
        LATBbits.LATB0 = 1;
        __delay_ms(2);
        LATBbits.LATB0 = 0;
        LATD = decod[mensaje[indice]-0x41];
