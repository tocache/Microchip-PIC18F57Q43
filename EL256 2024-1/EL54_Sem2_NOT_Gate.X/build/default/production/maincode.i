...
configuro:
    ...
    bsf OSCEN, 6 ;((OSCEN) and 0FFh), 6, b=1 habilitamos el HFINTOSC
    movlb 4H ;Nos vamos al BANK4
    ;config E/S
    bsf TRISE, 0 ;Puerto ((PORTE) and 0FFh), 0, a como entrada
    bcf ANSELE, 0 ;Puerto ((PORTE) and 0FFh), 0, a como digital
    bcf TRISF, 0 ;Puerto ((PORTF) and 0FFh), 0, a como salida
    bcf ANSELF, 0 ;Puerto ((PORTF) and 0FFh), 0, a como digital
...
es_falso:
    bsf LATF, 0 ;((PORTF) and 0FFh), 0, a a uno
    bra inicio ;salto a etiqueta inicio

es_verdad:
    bcf LATF, 0 ;((PORTF) and 0FFh), 0, a a cero
    bra inicio ;salto a etiqueta inicio
