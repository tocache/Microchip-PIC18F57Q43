...
configuro:
    ...
    ;((PORTB) and 0FFh), 4, a como entrada digital y pullup activado
    bsf TRISB, 4 ;((PORTB) and 0FFh), 4, a es una entrada
    bcf ANSELB, 4 ;((PORTB) and 0FFh), 4, a es digital
    bsf WPUB, 4 ;((PORTB) and 0FFh), 4, a tiene pullup
    ;((PORTF) and 0FFh), 3, a como salida digital
    bcf TRISF, 3 ;((PORTF) and 0FFh), 3, a es una salida
    bcf ANSELF, 3 ;((PORTF) and 0FFh), 3, a es digital

inicio:
    btfsc PORTB, 4 ;Leo el puerto y pregunto si ((PORTB) and 0FFh), 4, a=0
    bra falso ;Salta aqui cuando es falso
    bsf LATF, 3 ;Si es cierto ((PORTF) and 0FFh), 3, a=1
