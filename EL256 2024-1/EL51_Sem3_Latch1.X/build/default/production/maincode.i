...
configuro: ;label configuro
    ...
    movlb 4H ;al BANK4
    bsf TRISD, 2, 1 ;((PORTD) and 0FFh), 2, a como entrada
    bcf ANSELD, 2, 1 ;((PORTD) and 0FFh), 2, a como digital
    bcf TRISF, 1, 1 ;((PORTF) and 0FFh), 1, a como salida
    bcf ANSELF, 1, 1 ;((PORTF) and 0FFh), 1, a como digital
    bcf TRISF, 2, 1 ;((PORTF) and 0FFh), 2, a como salida
    bcf ANSELF, 2, 1 ;((PORTF) and 0FFh), 2, a como digital
    bcf LATF, 1, 1 ;((PORTF) and 0FFh), 1, a en cero
    bcf LATF, 2, 1 ;((PORTF) and 0FFh), 2, a en cero
inicio:
