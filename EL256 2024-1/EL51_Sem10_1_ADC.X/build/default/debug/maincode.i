...
void main(void) {
    ...
    while(1){
        ...
        POS_CURSOR(2,0);
        ENVIA_CHAR((valor_leido / 10000) + 0x30);
        ENVIA_CHAR(((valor_leido % 10000) / 1000) + 0x30);
        ENVIA_CHAR(((valor_leido % 1000) / 100) + 0x30);
        ENVIA_CHAR(((valor_leido % 100) / 10) + 0x30);
        ENVIA_CHAR((valor_leido % 10) + 0x30);
        voltaje = valor_leido * 0.122;
        final = voltaje;
        POS_CURSOR(2,8);
        ENVIA_CHAR(((final % 1000) / 100) + 0x30);
        ENVIA_CHAR('.');
        ENVIA_CHAR(((final % 100) / 10) + 0x30);
        ENVIA_CHAR((final % 10) + 0x30);
        ENVIA_CHAR('V');
    }
}
