...
FINAL_IMAGE=${DISTDIR}/EL51_Sem4_Deco_7S2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=maincode.s blablabla.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/maincode.o ${OBJECTDIR}/blablabla.o
POSSIBLE_DEPFILES=${OBJECTDIR}/maincode.o.d ${OBJECTDIR}/blablabla.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/maincode.o ${OBJECTDIR}/blablabla.o

# Source Files
SOURCEFILES=maincode.s blablabla.s
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/EL51_Sem4_Deco_7S2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC18F57Q43
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/EL51_Sem4_Deco_7S2.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
...
${OBJECTDIR}/blablabla.o: blablabla.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/blablabla.o 
	${MP_AS} -mcpu=PIC18F57Q43 -c \
	-o ${OBJECTDIR}/blablabla.o \
	blablabla.s \
	 -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -misa=std -msummary=+mem,-psect,-class,-hex,-file,-sha1,-sha256,-xml,-xmlfull -fmax-errors=20 -mwarn=0 -xassembler-with-cpp
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/EL51_Sem4_Deco_7S2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC18F57Q43 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/EL51_Sem4_Deco_7S2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
