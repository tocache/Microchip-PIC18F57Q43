...
void main(void) {
    ...
    while(1){
        ...
        POS_CURSOR(2,0);
        ENVIA_CHAR((resultado / 10000) + 0x30);
        ENVIA_CHAR(((resultado % 10000) / 1000) + 0x30);
        ENVIA_CHAR(((resultado % 1000) / 100) + 0x30);
        ENVIA_CHAR(((resultado % 100) / 10) + 0x30);
        ENVIA_CHAR((resultado % 10) + 0x30);
        _delay((unsigned long)((100)*(32000000UL/4000.0)));
        escalamiento = resultado / 0.122;
        intermedio = escalamiento;
        POS_CURSOR(2,8);
        ENVIA_CHAR(((intermedio % 1000) / 100) + 0x30);
        ENVIA_CHAR('.');
        ENVIA_CHAR(((intermedio % 100) / 10) + 0x30);
        ENVIA_CHAR((intermedio % 10) + 0x30);
        ENVIA_CHAR('V');
    }
}
