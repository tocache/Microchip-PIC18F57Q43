...
FINAL_IMAGE=${DISTDIR}/Sem8_TP.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/Sem8_TP.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
