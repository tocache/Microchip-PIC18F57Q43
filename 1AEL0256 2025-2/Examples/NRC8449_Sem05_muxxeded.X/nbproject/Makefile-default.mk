...
FINAL_IMAGE=${DISTDIR}/NRC8449_Sem05_muxxeded.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=mancode01.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/mancode01.o
POSSIBLE_DEPFILES=${OBJECTDIR}/mancode01.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/mancode01.o

# Source Files
SOURCEFILES=mancode01.s
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/NRC8449_Sem05_muxxeded.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC18F57Q43
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/NRC8449_Sem05_muxxeded.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/mancode01.o: mancode01.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/mancode01.o 
	${MP_AS} -mcpu=PIC18F57Q43 -c \
	-o ${OBJECTDIR}/mancode01.o \
	mancode01.s \
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/NRC8449_Sem05_muxxeded.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC18F57Q43 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/NRC8449_Sem05_muxxeded.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
