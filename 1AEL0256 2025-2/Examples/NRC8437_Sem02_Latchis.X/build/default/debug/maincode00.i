...
configuro:
    ...
    movlw 0FCH
    movwf ANSELF, 1 ;((PORTF) and 0FFh), 0, a y ((PORTF) and 0FFh), 1, a como digitales

inicio:
    btfsc PORTF, 0, 1 ;pregunta si ((PORTF) and 0FFh), 0, a es cero
    bra preguntaRF1 ;falso y se va a preguntar al ((PORTF) and 0FFh), 1, a
    btg LATB, 0, 1 ;bascular ((PORTB) and 0FFh), 0, a
otro1:
    btfss PORTF, 0, 1 ;pregunto si ((PORTF) and 0FFh), 0, a es uno
    bra otro1 ;falso, regresa a preguntar
    bra inicio ;verdad, regresa a inicio
preguntaRF1:
    btfsc PORTF, 1, 1 ;pregunta sio ((PORTF) and 0FFh), 1, a es cero
