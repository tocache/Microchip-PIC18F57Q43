...
configuro:
    ...
    movlb 4H
    movlw 0FFH
    movwf TRISA, 1 ;((PORTA) and 0FFh), 3, a al ((PORTA) and 0FFh), 0, a como entradas
    movlw 0F0H
...
inicio:
    ...
    andlw 0FH ;operacion de enmascaramiento para que pase solo ((PORTA) and 0FFh), 3, a a ((PORTA) and 0FFh), 0, a
    ...
    movlw 01H
    movwf LATF, 1 ;encendiendo solo ((PORTF) and 0FFh), 0, a
    bra inicio
preguntasiguiente1:
    cpfseq TBLPTRL, 1 ;pregunto si TBLPTRL es igual a 5
    bra esmenor
    movlw 02H
    movwf LATF, 1 ;enciendiendo solo ((PORTF) and 0FFh), 1, a
    bra inicio
esmenor:
    movlw 04H
    movwf LATF, 1 ;enciendo solo ((PORTF) and 0FFh), 2, a
    bra inicio
    end upcinos
