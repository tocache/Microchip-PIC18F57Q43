...
# 334 "C:/Program Files/Microchip/MPLABX/v6.25/packs/Microchip/PIC18F-Q_DFP/1.27.449/xc8\\pic\\include/pic18_chip_select.inc" 3
# 1 "C:/Program Files/Microchip/MPLABX/v6.25/packs/Microchip/PIC18F-Q_DFP/1.27.449/xc8\\pic\\include\\proc/pic18f57q43.inc" 1 3
# 47 "C:/Program Files/Microchip/MPLABX/v6.25/packs/Microchip/PIC18F-Q_DFP/1.27.449/xc8\\pic\\include\\proc/pic18f57q43.inc" 3
CLKRCON equ 0039h
...
TOSU equ 04FFh
# 36960 "C:/Program Files/Microchip/MPLABX/v6.25/packs/Microchip/PIC18F-Q_DFP/1.27.449/xc8\\pic\\include\\proc/pic18f57q43.inc" 3
...
# 335 "C:/Program Files/Microchip/MPLABX/v6.25/packs/Microchip/PIC18F-Q_DFP/1.27.449/xc8\\pic\\include/pic18_chip_select.inc" 2 3
...
configuro:
    ...
    movlb 4H
    movlw 80H
    movwf TRISD, 1 ;((PORTD) and 0FFh), 6, a al ((PORTD) and 0FFh), 0, a son salidas
    movwf ANSELD, 1 ;((PORTD) and 0FFh), 6, a al ((PORTD) and 0FFh), 0, a son digitales
    movlw 0F0H
    movwf TRISB, 1 ;((PORTB) and 0FFh), 3, a al ((PORTB) and 0FFh), 0, a son salidas
    movwf ANSELB, 1 ;((PORTB) and 0FFh), 3, a al ((PORTB) and 0FFh), 0, a son digitales
    movlw 0FCH ;((PORTF) and 0FFh), 1, a y ((PORTF) and 0FFh), 0, a por defecto son entradas
    movwf ANSELF, 1 ;((PORTF) and 0FFh), 1, a y ((PORTF) and 0FFh), 0, a son digitales
    movlw 03H
    movwf WPUF, 1 ;((PORTF) and 0FFh), 1, a y ((PORTF) and 0FFh), 0, a con pullup activadas
...
inicio:
    btfsc PORTF, 0, 1 ;pregunto si ((PORTF) and 0FFh), 0, a=0 (presione btn)
...
union1:
    movlb 4H
    btfss PORTF, 0, 1 ;pregunto si ((PORTF) and 0FFh), 0, a=1 (solte btn)
    bra union1
    bra union3
sgte_btn:
    btfsc PORTF, 1, 1 ;pregunto si ((PORTF) and 0FFh), 1, a=0 (si presione btn)
    bra union3
    movlb 5H
    movlw 0
...
union2:
    movlb 4H
    btfss PORTF, 1, 1 ;pregunta si ((PORTF) and 0FFh), 1, a=1 (si soltaste btn)
    bra union2
union3:
    call multiplex
    bra inicio
...
multiplex:
    ...
    bsf LATB, 0, 1 ;((PORTB) and 0FFh), 0, a=1, habilito primer digito del display
    call nopes
    bcf LATB, 0, 1 ;((PORTB) and 0FFh), 0, a=0, deshabilitado el primer digito del display
    TBLRD*+ ;accion de lectura y posterior incremento de TBLPTR
    movff TABLAT, LATD ;mover contenido de TABLAT hacia RD
    bsf LATB, 1, 1 ;((PORTB) and 0FFh), 0, a=1, habilito segundo digito del display
    call nopes
    bcf LATB, 1, 1 ;((PORTB) and 0FFh), 0, a=0, deshabilitado el segundo digito del display
    TBLRD*+ ;accion de lectura y posterior incremento de TBLPTR
    movff TABLAT, LATD ;mover contenido de TABLAT hacia RD
    bsf LATB, 2, 1 ;((PORTB) and 0FFh), 0, a=1, habilito primer digito del display
    call nopes
    bcf LATB, 2, 1 ;((PORTB) and 0FFh), 0, a=0, deshabilitado el primer digito del display
    TBLRD* ;accion de lectura
    movff TABLAT, LATD ;mover contenido de TABLAT hacia RD
    bsf LATB, 3, 1 ;((PORTB) and 0FFh), 0, a=1, habilito primer digito del display
    call nopes
    bcf LATB, 3, 1 ;((PORTB) and 0FFh), 0, a=0, deshabilitado el primer digito del display
    return
