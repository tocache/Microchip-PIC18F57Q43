...
configuro:
    ...
    movlb 4H
    movlw 80H
    movwf TRISD, 1 ;((PORTD) and 0FFh), 0, a al ((PORTD) and 0FFh), 6, a como salidas
    movwf ANSELD, 1 ;((PORTD) and 0FFh), 0, a al ((PORTD) and 0FFh), 6, a como digitales
    movlw 0FFH
    ...
    movlw 0FH
    movwf WPUA, 1 ;((PORTA) and 0FFh), 3, a al Ra0 con pullup activadas
...
inicio:
    ...
    andlw 0FH ;operacion de enmascaramiento, para que solo pase ((PORTA) and 0FFh), 3, a a ((PORTA) and 0FFh), 0, a
