...
configuro:
    ...
    movlb 2H
    movlw 39H
    movwf RC5PPS, 1 ;((PORTC) and 0FFh), 5, a conectado a TMR0
    ;conf del TMR0
    movlb 3H
    movlw 80H
    ...
    ;conf E/S
    movlb 4H
    bcf TRISC, 5, 1 ;((PORTC) and 0FFh), 5, a como salida
    bcf ANSELC, 5, 1 ;((PORTC) and 0FFh), 5, a como digital
    bcf ANSELB, 1, 1 ;((PORTB) and 0FFh), 1, a como digital
    bsf WPUB, 1, 1 ;((PORTB) and 0FFh), 1, a con pullup activado
    bcf TRISD, 6, 1 ;((PORTD) and 0FFh), 6, a como salida
    bcf ANSELD, 6, 1 ;((PORTD) and 0FFh), 6, a como digital
    bcf ANSELE, 1, 1 ;((PORTE) and 0FFh), 1, a como digital
    bsf WPUE, 1, 1 ;((PORTE) and 0FFh), 1, a con pullup activado
